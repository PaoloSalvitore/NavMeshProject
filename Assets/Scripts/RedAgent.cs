...
public class RedAgent : MonoBehaviour
{
    ...
    [SerializeField] private float _grassSpeed = 8f; //speed while on green platform
    [SerializeField] private float _redSpeed = 12f; //speed while on red platform
    [SerializeField] private float _blueSpeed = 6f; //speed while on blue platform
    #endregion
