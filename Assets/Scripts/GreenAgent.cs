...
public class GreenAgent : MonoBehaviour
{
    ...
    [SerializeField] private float _grassSpeed = 12f; //speed while on green platform
    [SerializeField] private float _redSpeed = 6f; //speed while on red platform
    [SerializeField] private float _blueSpeed = 8f; //speed while on blue platform
    #endregion
